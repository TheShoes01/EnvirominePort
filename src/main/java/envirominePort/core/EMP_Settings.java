...
public class EMP_Settings {
    ...
    public static final String ModID = "envirominePort";
    public static final String Channel = "EMP_CH";
    public static final String Name = "EnviroMinePort";
    public static final String Proxy = "envirominePort.core.proxies";
