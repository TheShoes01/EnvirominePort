...
public class HUDRegistry {
    ...
    public static void registerHudItemM(HudItem hudItem) {
    ...
    public static boolean checkForResize() {
        ...
        ScaledResolution scaledresoltuion = new ScaledResolution(mc);
        if (scaledresoltuion.getScaledWidth() != screenWidth || scaledresoltuion.getScaledHeight() != screenHeight) {
            if (screenWidth != 0) {
                fixHudItemOffsets(scaledresoltuion.getScaledWidth(), scaledresoltuion.getScaledHeight(), screenWidth, screenHeight);
            }
            screenWidth = scaledresoltuion.getScaledWidth();
            screenHeight = scaledresoltuion.getScaledHeight();
            return true;
        }
        return false;
    }

    private static void fixHudItemOffsets(int newScrenWidth, int newScreenHeight, int oldScreenWidth, int oldScreenHeight) {
    ...
    public static void setInitialLoadCcomplete(boolean b) {
